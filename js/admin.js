...
function renderSettings() {
  ...
  const fields = {
    ...
    'settingRazorpayEnabled': settings.razorpayEnabled !== undefined ? String(settings.razorpayEnabled) : 'false',
    'settingRazorpayMode': settings.razorpayMode || 'sandbox',
    'settingRazorpayKeyId': settings.razorpayKeyId || '',
    'settingRazorpayKeySecret': settings.razorpayKeySecret || '',
  ...
  if (form && !form.dataset.initialized) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      const updates = {
        ...
        razorpayEnabled: document.getElementById('settingRazorpayEnabled').value === 'true',
        razorpayMode: document.getElementById('settingRazorpayMode').value,
        razorpayKeyId: document.getElementById('settingRazorpayKeyId').value.trim(),
        razorpayKeySecret: document.getElementById('settingRazorpayKeySecret').value.trim(),
