...
function renderSettings() {
  ...
  const fields = {
    ...
    'settingMerchantEnabled': settings.merchantEnabled !== undefined ? String(settings.merchantEnabled) : 'false',
    'settingMerchantMode': settings.merchantMode || 'sandbox',
    'settingMerchantKeyId': settings.merchantKeyId || '',
    'settingMerchantKeySecret': settings.merchantKeySecret || '',
    'settingMerchantWebhookSecret': settings.merchantWebhookSecret || '',
  ...
  if (form && !form.dataset.initialized) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      const updates = {
        ...
        merchantEnabled: document.getElementById('settingMerchantEnabled').value === 'true',
        merchantMode: document.getElementById('settingMerchantMode').value,
        merchantKeyId: document.getElementById('settingMerchantKeyId').value.trim(),
        merchantKeySecret: document.getElementById('settingMerchantKeySecret').value.trim(),
        merchantWebhookSecret: document.getElementById('settingMerchantWebhookSecret').value.trim(),
