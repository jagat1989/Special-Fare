...
const FlightData = (() => {
  ...
  const AIRPORTS = [
    ...
    { code: 'GOI', city: 'Goa (Dabolim)', name: 'Dabolim Airport', state: 'Goa', tier: 1 },
    { code: 'GOX', city: 'Goa (Mopa)', name: 'Manohar International Airport', state: 'Goa', tier: 1 },
    { code: 'COK', city: 'Kochi', name: 'Cochin International Airport', state: 'Kerala', tier: 1 },
    { code: 'PNQ', city: 'Pune', name: 'Pune International Airport', state: 'Maharashtra', tier: 1 },
    ...
    { code: 'IXZ', city: 'Port Blair', name: 'Veer Savarkar International Airport', state: 'Andaman & Nicobar', tier: 2 },
    { code: 'AGR', city: 'Agra', name: 'Agra Airport', state: 'Uttar Pradesh', tier: 2 },
    { code: 'AJL', city: 'Aizawl', name: 'Lengpui Airport', state: 'Mizoram', tier: 2 },
    { code: 'BHO', city: 'Bhopal', name: 'Raja Bhoj Airport', state: 'Madhya Pradesh', tier: 2 },
    { code: 'BHU', city: 'Bhavnagar', name: 'Bhavnagar Airport', state: 'Gujarat', tier: 2 },
    { code: 'DIB', city: 'Dibrugarh', name: 'Dibrugarh Airport', state: 'Assam', tier: 2 },
    { code: 'GOP', city: 'Gorakhpur', name: 'Gorakhpur Airport', state: 'Uttar Pradesh', tier: 2 },
    { code: 'GWL', city: 'Gwalior', name: 'Rajmata Vijayaraje Scindia Airport', state: 'Madhya Pradesh', tier: 2 },
    { code: 'IMF', city: 'Imphal', name: 'Imphal International Airport', state: 'Manipur', tier: 2 },
    { code: 'JLR', city: 'Jabalpur', name: 'Jabalpur Airport', state: 'Madhya Pradesh', tier: 2 },
    { code: 'JSA', city: 'Jaisalmer', name: 'Jaisalmer Airport', state: 'Rajasthan', tier: 2 },
    { code: 'JDH', city: 'Jodhpur', name: 'Jodhpur Airport', state: 'Rajasthan', tier: 2 },
    { code: 'CDP', city: 'Kadapa', name: 'Kadapa Airport', state: 'Andhra Pradesh', tier: 2 },
    { code: 'KLH', city: 'Kolhapur', name: 'Kolhapur Airport', state: 'Maharashtra', tier: 2 },
    { code: 'RJA', city: 'Rajahmundry', name: 'Rajahmundry Airport', state: 'Andhra Pradesh', tier: 2 },
    { code: 'TIR', city: 'Tirupati', name: 'Tirupati Airport', state: 'Andhra Pradesh', tier: 2 },
    ...
    { code: 'SHL', city: 'Shillong', name: 'Shillong Airport', state: 'Meghalaya', tier: 2 },
    { code: 'DMU', city: 'Dimapur', name: 'Dimapur Airport', state: 'Nagaland', tier: 2 },
    { code: 'JRH', city: 'Jorhat', name: 'Jorhat Airport', state: 'Assam', tier: 2 },
    { code: 'TEZ', city: 'Tezpur', name: 'Tezpur Airport', state: 'Assam', tier: 2 },
    { code: 'IXG', city: 'Belagavi', name: 'Belgaum Airport', state: 'Karnataka', tier: 2 },
    { code: 'MYQ', city: 'Mysuru', name: 'Mysore Airport', state: 'Karnataka', tier: 2 },
    { code: 'HBX', city: 'Hubballi', name: 'Hubli Airport', state: 'Karnataka', tier: 2 },
    { code: 'GAY', city: 'Gaya', name: 'Gaya Airport', state: 'Bihar', tier: 2 },
    { code: 'DAR', city: 'Darbhanga', name: 'Darbhanga Airport', state: 'Bihar', tier: 2 },
    { code: 'JGB', city: 'Jagdalpur', name: 'Jagdalpur Airport', state: 'Chhattisgarh', tier: 2 },
    { code: 'HSR', city: 'Hisar', name: 'Hisar Airport', state: 'Haryana', tier: 2 },
    { code: 'KUU', city: 'Kullu', name: 'Bhuntar Airport', state: 'Himachal Pradesh', tier: 2 },
    { code: 'DHM', city: 'Dharamshala', name: 'Kangra Airport', state: 'Himachal Pradesh', tier: 2 },
    { code: 'HGI', city: 'Itanagar', name: 'Donyi Polo Airport', state: 'Arunachal Pradesh', tier: 2 },
    { code: 'RUR', city: 'Rourkela', name: 'Rourkela Airport', state: 'Odisha', tier: 2 },
    { code: 'JYG', city: 'Jeypore', name: 'Jeypore Airport', state: 'Odisha', tier: 2 },
    { code: 'SLN', city: 'Salem', name: 'Salem Airport', state: 'Tamil Nadu', tier: 2 },
    { code: 'IXY', city: 'Kandla', name: 'Kandla Airport', state: 'Gujarat', tier: 2 },
    { code: 'PBD', city: 'Porbandar', name: 'Porbandar Airport', state: 'Gujarat', tier: 2 },
    { code: 'RAJ', city: 'Rajkot', name: 'Rajkot Airport', state: 'Gujarat', tier: 2 },
    { code: 'KNP', city: 'Kanpur', name: 'Kanpur Airport', state: 'Uttar Pradesh', tier: 2 },
    { code: 'IXD', city: 'Prayagraj', name: 'Allahabad Airport', state: 'Uttar Pradesh', tier: 2 },
    { code: 'BEK', city: 'Bareilly', name: 'Bareilly Airport', state: 'Uttar Pradesh', tier: 2 },
    { code: 'HND', city: 'Hindon', name: 'Hindon Airport', state: 'Uttar Pradesh', tier: 2 },
    { code: 'STV', city: 'Surat', name: 'Surat Airport', state: 'Gujarat', tier: 2 },
    { code: 'BUP', city: 'Bathinda', name: 'Bathinda Airport', state: 'Punjab', tier: 2 },
    { code: 'IXP', city: 'Pathankot', name: 'Pathankot Airport', state: 'Punjab', tier: 2 },
    { code: 'BHJ', city: 'Bhuj', name: 'Bhuj Airport', state: 'Gujarat', tier: 2 },
    { code: 'OMR', city: 'Kurnool', name: 'Kurnool Airport (Orvakal)', state: 'Andhra Pradesh', tier: 2 },
    { code: 'PNY', city: 'Puducherry', name: 'Pondicherry Airport', state: 'Puducherry', tier: 2 },
    { code: 'VDG', city: 'Vidyanagar', name: 'Vidyanagar Airport', state: 'Karnataka', tier: 2 },
    { code: 'JGA', city: 'Jamnagar', name: 'Jamnagar Airport', state: 'Gujarat', tier: 2 },
    { code: 'QGN', city: 'Gondia', name: 'Birsi Airport', state: 'Maharashtra', tier: 2 },
    { code: 'NDC', city: 'Nanded', name: 'Shri Guru Gobind Singh Ji Airport', state: 'Maharashtra', tier: 2 },
    { code: 'LTU', city: 'Latur', name: 'Latur Airport', state: 'Maharashtra', tier: 2 },
    { code: 'SAG', city: 'Shirdi', name: 'Shirdi Airport', state: 'Maharashtra', tier: 2 },
    { code: 'SDG', city: 'Sindhudurg', name: 'Sindhudurg Airport', state: 'Maharashtra', tier: 2 },
    { code: 'GBI', city: 'Kalaburagi', name: 'Kalaburagi Airport', state: 'Karnataka', tier: 2 },
    { code: 'JRG', city: 'Jharsuguda', name: 'Veer Surendra Sai Airport', state: 'Odisha', tier: 2 },
    { code: 'KQH', city: 'Kishangarh', name: 'Kishangarh Airport', state: 'Rajasthan', tier: 2 },
    { code: 'KBK', city: 'Kushinagar', name: 'Kushinagar International Airport', state: 'Uttar Pradesh', tier: 2 }
  ];
